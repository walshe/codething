...
public class UserTest {
	...
	public void totalCaloriesBurntIncludingBmr() {
		...
		// verify
		assertThat(totalCaloriesBurntIncludingBmrUser1,
				is(running.getCaloriesBurnt() + (user1.getBmr() * running.getDurationInMinutes() / 1440)));
		assertThat(totalCaloriesBurntIncludingBmrUser2,
				is(running.getCaloriesBurnt() + (user2.getBmr() * running.getDurationInMinutes() / 1440)));
